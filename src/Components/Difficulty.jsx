...
const Difficulty = () => {
  ...
  return (
    <div className="w-fit h-fit relative group pt-1">
        <div className="max-sm:hidden block"><Label text={'Difficulty'} /></div>
        <div className='relative min-w-40 mt-1'>
            <div className="w-full min-w-32 p-1 px-4 rounded-xl mb-1.5 border-[3px]
             border-red-800 text-[#973131] bg-[#F5E7B2] font-roadrage text-xl max-sm:text-lg text-center shadow-sm shadow-gray-700 cursor-auto select-none" >
