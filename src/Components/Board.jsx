                    ...
                    {_.times(9, c=>(
                        ...
                        >
                            <div 
                                ...
                                {game.isRunning && game.board.length && !game.board[r][c] && <div className='absolute grid grid-cols-3 grid-rows-3 text-[10px] lg:h-12 lg:w-12 h-10 w-10 mb-6 p-1.5 gap-2 text-gray-600'>
                                    {/* notes[r][c].map(num=>) */}
